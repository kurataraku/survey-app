...
const FOCUS_PROFILE_DEFS: FocusProfileDef[] = [
  {
    ...
    profile: {
      ...
      instruction:
        '発達特性・個別伴走が相談の中心です。候補校は、発達障害やASD/ADHDへの明示的な理解、個別面談、少人数、担任・カウンセラー・SSWの伴走、レポート提出の声かけ、静かな環境、オンライン代替や振替対応に関する根拠がある学校を優先してください。本人の性別・居住地・通学可能時間など前の発話で出た制約を落とさないでください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '年数回・低頻度通学が相談の中心です。候補校は、集中スクーリング、オンライン中心、自宅学習、最少登校日数、振替対応に関する根拠がある学校を優先してください。年1〜3回で確実に卒業できると断定せず、公式日程と卒業要件の確認を促してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '日帰りスクーリングが相談の中心です。候補校は、宿泊を伴わない通学型スクーリング、日帰りで通えるキャンパス、振替・オンライン代替に関する根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        'イラスト・デザインが相談の中心です。候補校は、マンガ・イラスト・デザイン・アニメ・美術・動画制作系コース、作品制作、ポートフォリオ指導、専門講師に関する根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        'スポーツ・部活動との両立が相談の中心です。候補校は、部活動の充実、大会出場、スポーツコース・体育コース、練習や遠征と学業の両立、通学日程の柔軟さに関する口コミ根拠がある学校を優先してください。部活の有無や大会出場の可否は学校・キャンパスごとに差が大きいため、根拠がない学校は「根拠は弱め」と明記し、説明会や見学での確認を促してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '学校生活をもう一度楽しみたい・友人が欲しいという前向きな気持ちが相談の中心です。候補校は、行事やイベントの充実、友人づくりのきっかけ、生徒同士の交流、居場所づくり、通学時の楽しい雰囲気に関する口コミ根拠がある学校を優先してください。友人関係を築きにくいという口コミがある学校は、その旨を注意点として正直に伝えてください。',
    },
  },
  {
    detect: /オンライン(?:授業|学習|中心|完結|のみ|だけ|コース|が(?:いい|良い|よい)|希望|で(?:学|勉強|授業|いい|良い|完結))|ネットで(?:学|勉強|授業|完結)|自宅で(?:学|勉強|授業|完結)|在宅で|(?:通学|登校)(?:なし|せず|しない|したくない)|通わずに|家から出(?:ずに|ないで|たくない)/u,
    profile: {
      keywords: [
        'オンライン',
        'ネットコース',
  ...
  },
  {
    ...
    profile: {
      ...
      instruction:
        'ネットコース・学費重視が相談の中心です。候補校は、オンライン中心で通学負担が少ないこと、学費の安さ・納得感・追加費用の少なさに関する口コミや学費情報がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '落ち着いた雰囲気が相談の中心です。候補校は、雰囲気評価が高い、少人数、落ち着いている、派手さ・にぎやかさが強すぎないことに関する口コミ根拠がある学校を優先してください。「ギャル」「ヤンキー」のような表現は決めつけず、服装規定・校風・在校生の雰囲気として丁寧に言い換えてください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '就職・キャリア支援が相談の中心です。候補校は、資格取得、職業体験、企業連携、求人紹介、面接・履歴書指導、卒業後の進路相談に関する口コミ根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '大学受験・進学が相談の中心です。候補校は、進路相談・大学合格・受験時間の確保・指定校推薦・面接練習・模試・予備校連携など、進学に直接関係する口コミ根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '朝起きられない・体調面が相談の中心です。候補校は、登校時間の柔軟性、オンライン代替、振替スクーリング、体調への配慮、生活リズムの伴走に関する口コミ根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '学習遅れ・学び直しが相談の中心です。候補校は、基礎からの学び直し、レポート提出支援、個別フォロー、補習、添削に関する口コミ根拠がある学校を優先してください。',
    },
  },
  {
    ...
    profile: {
      ...
      instruction:
        '不登校・人間関係が相談の中心です。候補校は、少人数、先生の寄り添い、面談、登校再開、居場所づくりに関する口コミ根拠がある学校を優先してください。',
    },
  },
];
...
function buildSearchQuery(latestUserMessage: string): string {
  ...
  if (/オンライン|ネットコース|ネットで(?:学|勉強|授業)|自宅で(?:学|勉強|授業)|在宅|(?:通学|登校)(?:なし|せず|しない|したくない)|通わずに/u.test(latestUserMessage)) {
    fragments.push(
      'オンライン ネットコース 自宅学習 在宅 映像授業 通学なし スクーリング 登校日数'
    );
  }
  ...
  try {
    ...
    const items = ranked.map(({ row }, index) => {
      const conditions = [
        ...
        row.focus_label ? `相談テーマ=${row.focus_label}` : null,
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const focusInstruction =
      focusList.length > 1
        ? `今回の相談で気にされているポイントは複数あります。相談文で先に述べられたものほど優先度が高いものとして扱い、すべてのポイントに回答内で必ず触れてください。` +
          focusList
            .map(
              (profile, index) =>
                `【ポイント${index + 1}${index === 0 ? '（最優先）' : ''}: ${profile.label}】${profile.instruction}`
            )
            .join('') +
          ' 候補校リストの各校には「口コミ根拠があるテーマ」を付記しています。あるテーマを絶対条件として扱う指示がある場合は、そのテーマが付記された学校を優先して候補に選び、付記のない学校をそれより先に選ばないでください。 各候補校の説明では、最優先のポイントに直接関係する口コミ根拠を最低1つは明記し、2番目以降のポイントについても口コミ根拠か確認ポイントのどちらかで必ず触れてください。最優先のポイントに関する根拠が薄い学校は、候補にしないか「根拠は弱め」と明記してください。2番目以降のポイントについて参照情報に口コミ根拠が見つからない場合は、曖昧にぼかさず「◯◯に関する口コミ根拠は今回見つからなかったため、見学・説明会での確認ポイントとして挙げます」と正直に明示してください。回答本文では「主訴」「ポイント1」「最優先のポイント」のような内部ラベルや専門用語を使わず、「不登校からの再スタート」「友達づくり」のように内容そのものの言葉で表現してください。'
        : focus
    ...
    const regionalFollowUpInstruction = regionalFollowUp
      ? '最新発話は地域だけの追加条件です。直前に提示した候補校に限定せず、この地域で通える学校を再選定してください。前の会話にある本人条件・相談内容・登校希望は維持してください。'
      : '';
      ...
      conciseRequest
        ...
        : intent === 'general_advice'
          ...
          : route.prefecture
            ...
            : '地域指定がない推薦質問です。通学圏での断定は避けつつ、今回の相談内容に関する口コミ根拠が強い学校を「参考候補」として2〜3校示してください。冒頭で「地域未指定のため、通えるかは別途確認が必要ですが、口コミ上の根拠が強い参考候補として挙げます。都道府県を教えてもらえれば地域内候補に絞れます」と明記してください。候補校は最大3校です。「その他の候補」「補足候補」として4校目以降の学校名を出さないでください。候補校の###見出しには、候補校リスト内の実名校だけを書いてください。必ず次のMarkdown見出し構成で回答してください: ## 口コミ根拠が強い参考候補 / ## 選んだ理由 / ## 地域指定後に確認したいこと。学校候補の各校名は ### 見出しにしてください。';
    ...
    const completionMessages = [
      {
        ...
        content:
          ...
          '大学受験・進学が相談の中心の場合は、指定校推薦の枠だけでなく、一般受験対策、総合型選抜対策、模試、進路面談、外部予備校連携、学習計画の伴走を比較してください。' +
          '勉強の遅れ・学習不安が相談の中心の場合は、大学受験実績よりも、基礎からの学び直し、レポート提出の伴走、個別フォロー、少人数、登校頻度の柔軟さを優先して比較してください。' +
          ...
          '保護者に寄り添う丁寧で温かい語り口にしてください。「主訴」のような専門用語・内部用語は使わず、日常の言葉で書いてください。' +
